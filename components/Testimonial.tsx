...
export default function Testimonial() {
  return (
    <section id="testimonial" className="animate-on-scroll" style={{ 
      padding: '140px 0',
      position: 'relative',
      width: '100vw',
      marginLeft: 'calc(50% - 50vw)',
      background: 'linear-gradient(to bottom, rgba(37, 37, 37, 0.95) 0%, rgba(38, 38, 38, 0.97) 50%, rgba(40, 40, 40, 0.95) 100%)',
      ...
      <div style={{
        ...
        width: '120%',
        height: '60%',
        background: 'radial-gradient(ellipse at top center, rgba(212, 222, 149, 0.025), transparent 70%)',
        pointerEvents: 'none',
        zIndex: 0
      }}></div>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem', position: 'relative', zIndex: 1 }}>
        <div className="animate-on-scroll" style={{ 
          ...
          <p style={{ 
            ...
            Hear from our early users about how Keystone has transformed their journey
          </p>
        </div>
